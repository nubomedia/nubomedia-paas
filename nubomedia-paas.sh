...
function start {
	...
	screen -S nubomedia -p 0 -X screen -t nubomedia-paas-api java -jar "/opt/nubomedia/nubomedia-paas/build/libs/nubomedia-paas-api-$_version.jar" --spring.config.location=file:${_nubomedia_config_file}
