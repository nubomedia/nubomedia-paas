...
function start {
	...
	screen -c screenrc -S nubomedia -p 0 -X screen -t nubomedia-paas-api java -jar "build/libs/nubomedia-paas-api-$_version.jar" --spring.config.location=file:${_nubomedia_config_file}
